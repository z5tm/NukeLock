## Original project by [@Marco15453](https://github.com/Marco15453)! 

#### [The original repo can be found here.](https://github.com/Marco15453-Archived/NukeLock)
#### Please include the attribution above in any forks created.
...
# NOTE:
**I have obtained permission from the previous repository's owner, [@Marco15453](https://github.com/Marco15453) to update this plugin and publish it.**

**This fork is under Apache 2.0.**